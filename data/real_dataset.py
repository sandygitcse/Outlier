...
DATA_DIRS = '/mnt/cat/data/sandy/Forecasting/Telemanom/DILATE/'
...
def parse_telemetry(dataset_name, N_input, N_output, t2v_type=None):
    ...
    trn_channel_paths = glob.glob(os.path.join(DATA_DIRS, 'data', 'telemetry', 'data', 'training_data', '*'))
    tst_channel_paths = glob.glob(os.path.join(DATA_DIRS, 'data', 'telemetry', 'data', 'testing_data', '*'))
